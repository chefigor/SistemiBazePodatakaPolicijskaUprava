...
namespace UpravaLibrary.Mapiranja
{
	public class AlarmniSistemMapiranja : ClassMap<AlarmniSistem>
	{
		public AlarmniSistemMapiranja()
		{
			...
			HasMany(x => x.Zaduzeni).KeyColumn("SERIJSKIBR").Cascade.All().Inverse();
		}
	}

	internal class ToplotniAlarmniSisetmMapiranja : SubclassMap<ToplotniAlarmniSistem>
	{
	...
	internal class UltrazvucniAlarmniSistemMapiranja : SubclassMap<UltrazvucniAlarmniSistem>
	{
	...
	internal class DetekcijaPokretaAlarmniSistemMapiranja : SubclassMap<DetekcijaPokretaAlarmniSistem>
	{
